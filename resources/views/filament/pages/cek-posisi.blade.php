<x-filament-panels::page>
    <div class="flex flex-row gap-4">
        <div class="basis-2/3">
            <div style="width=100vh;height:77vh;" x-ignore ax-load ax-load-src="{{ \Filament\Support\Facades\FilamentAsset::getAlpineComponentSrc('cekposisi-js') }}" x-data="leafletAISMaps()">
                <div x-ref="map" id="map" style="width: 100%; height: 100%"></div>
            </div>
        </div>
        <div class="basis-auto">
            <x-filament::section>
                <x-filament::section.heading>Vessel Info</x-filament::section.heading>
    {{ $this->infolist }}
            </x-filament::section>
        </div>
    </div>
