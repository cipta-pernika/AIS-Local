...
')->whereNotNull('geofence_id')->whereNotNull('pnbp_jasa_labuh_kapal')
    ...
    public function summaryreport(Request $request)
    {
        ...
        $total_tidak_terjadwal_bongkar = TidakTerjadwal::whereBetween(DB::raw('DATE(created_at)'), [$startDateTime, $endDateTime])->whereNotNull('geofence_id')->whereNotNull('pnbp_jasa_labuh_kapal')->count();
