...
class HelperController extends Controller
{
    ...
    public function movebylatlng()
    {
        ...
        $url = 'http://admin:Amtek12345@192.168.5.222/ISAPI/PTZCtrl/channels/1/absolute';
        $ch = curl_init($url);
    ...
    {
        $xml_data = '"1.0" encoding="UTF-8"?><PTZData><zoom>0</zoom></PTZData>';
    ...
    {
        $xml_data = '"1.0" encoding="UTF-8"?><PTZData><zoom>60</zoom></PTZData>';
    ...
    {
        $url = 'http://admin:Amtek12345@192.168.5.222/ISAPI/PTZCtrl/channels/1/presets/1/goto';
    ...
    {
        $url = 'http://admin:Amtek12345@192.168.5.222/ISAPI/PTZCtrl/channels/1/presets/1';
        $ch = curl_init($url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'PUT');
        curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: text/xml'));

        curl_setopt($ch, CURLOPT_POSTFIELDS, '"1.0" encoding="UTF-8"?><PTZPreset xmlns="http://www.isapi.org/ver20/XMLSchema" version="2.0"><id>1</id><presetName>Preset 1</presetName></PTZPreset>'); // Empty body as specified in the cURL command
