...
interface IModalAisProps {
    isOpen: boolean;
    setIsOpen: any;
}

const ModalAis: FC<IModalAisProps> = ({
    isOpen, setIsOpen
}) => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${UrlBase}aisdatalist`);
