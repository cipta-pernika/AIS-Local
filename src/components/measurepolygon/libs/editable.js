...
(function (factory, window) {
    ...
    L.Editable.VertexMarker = L.Marker.extend({
        ...
        initialize(latlng, latlngs, editor, options) {
    ...
    L.Editable.MiddleMarker = L.Marker.extend({
        ...
        initialize(left, right, latlngs, editor, options) {
            this.left = left;
            this.right = right;
            this.editor = editor;
            this.latlngs = latlngs;
    ...
    L.Editable.PathEditor = L.Editable.BaseEditor.extend({
        ...
        onNewVertex(vertex) {
            ...
            this.fireAndForward('editable:vertex:new', { latlng: vertex.latlng, vertex });
        },
        ...
        _deleteShape(shape, latlngs) {
            ...
            for (let i = 0; i < latlngs.length; i++) {
                ...
                if (latlngs[i].indexOf(shape) !== -1) return spliceDelete(latlngs[i], shape);
            }
        },
    ...
    const PolygonMixin = {
        ...
        isInLatLngs(l, latlngs) {
            let inside = false;
            let l1; let l2; let j; let k; let len2;
