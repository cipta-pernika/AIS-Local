...
import { dashboardPagesMenu, demoPagesMenu, masterPagesMenu, pageLayoutTypesPagesMenu } from '../menu';
...
const MASTER = {
	DATALOGGERS: lazy(() => import('../pages/presentation/dataLoggers/DataLoggersPage')),
	SENSORS: lazy(() => import('../pages/presentation/sensors/SensorsPage')),
	USERS: lazy(() => import('../pages/presentation/users/UserPage')),
}
const AUTH = {
...
const presentation = [
	...
	{
		path: masterPagesMenu.dataLoggers.path,
		element: <MASTER.DATALOGGERS />,
	},
	{
		path: masterPagesMenu.sensors.path,
		element: <MASTER.SENSORS />,
	},
	{
		path: masterPagesMenu.users.path,
		element: <MASTER.USERS />,
	},
	{
