...
//camera
Route::post('camzoomminus', [CameraController::class, 'camzoomminus']);
Route::post('camzoomminuscon', [CameraController::class, 'camzoomminuscon']);
Route::post('camup', [CameraController::class, 'camup']);
Route::post('camupcon', [CameraController::class, 'camupcon']);
Route::post('camzoomplus', [CameraController::class, 'camzoomplus']);
...
Route::post('camrightup', [CameraController::class, 'camrightup']);
Route::post('camdown', [CameraController::class, 'camdown']);
Route::post('camautopan', [CameraController::class, 'camautopan']);
Route::post('camautopanstop', [CameraController::class, 'camautopanstop']);
Route::post('camstop', [CameraController::class, 'camstop']);
Route::post('camfocusmin', [CameraController::class, 'camfocusmin']);
Route::post('camfocusplus', [CameraController::class, 'camfocusplus']);
Route::post('camfocusstop', [CameraController::class, 'camfocusstop']);
Route::post('camleftdown', [CameraController::class, 'camleftdown']);
Route::post('camrightdown', [CameraController::class, 'camrightdown']);
Route::post('camirismin', [CameraController::class, 'camirismin']);
Route::post('camirisplus', [CameraController::class, 'camirisplus']);
Route::post('camirisstop', [CameraController::class, 'camirisstop']);
Route::post('camwiper', [CameraController::class, 'camwiper']);
Route::post('camstopwiper', [CameraController::class, 'camstopwiper']);
Route::post('cammenu', [CameraController::class, 'cammenu']);
Route::post('camstopzoom', [CameraController::class, 'camstopzoom']);

Route::post('movebylatlng', [CameraController::class, 'movebylatlng']);
Route::post('camset', [CameraController::class, 'camset']);
Route::post('camcall', [CameraController::class, 'camcall']);
